...
export class FooterComponent extends LitElement {
	...
	protected render () {
		return html`
			<aside>
				<span>Released under <a href="https://github.com/andreasbm/weightless/blob/master/LICENSE.md" target="_blank">MIT LICENSE</a>. Copyright © 2019 Andreas Mehlsen</span>
			</aside>
			<aside>
				<a class="social" href="${GITHUB_URL}" target="_blank">
					<img class="img" src="/assets/social/github.svg" alt="Github" />
				</a>
				<a class="social" href="${TWITTER_URL}" target="_blank">
