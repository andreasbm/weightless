...
import styles from "./wl-progress-spinner.scss";
...
export class WlProgressSpinner extends ProgressBehavior implements IProgressSpinnerProperties {
...
declare global {
	interface HTMLElementTagNameMap {
		"wl-progress-spinner": WlProgressSpinner;
	}
}
