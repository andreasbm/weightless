...
export async function showPopoverAtPosition<R> (config: IOpenOverlayConfig & Partial<IPopoverBaseProperties> & {position: IAnchorPosition}): Promise<IShowOverlayResult<R, IOpenOverlayConfig & Partial<IPopoverBaseProperties>, Popover<R>>> {
