...
import styles from "./wl-snackbar.scss";
...
export class WlSnackbar<R = unknown> extends OverlayBehavior<R, Partial<ISnackbarProperties>> implements ISnackbarProperties {
