...
import styles from "./wl-ripple.scss";
 ...
 */
export const RIPPLE_INITIAL_DURATION = 800;
...
export class WlRipple extends LitElement implements IRippleProperties {
	 ...
	 * @param props
	 */
	updated (props: Map<keyof IRippleProperties, unknown>) {
		super.updated(props);
